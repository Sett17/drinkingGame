define("./workbox-df9df33b.js", ["exports"], (function (t) {
    "use strict";
    try {
    ...
    class o {
        ...
        handleRequest({request: t, event: e}) {
            ...
            const n = s.origin === location.origin, {params: i, route: r} = this.findMatchingRoute({event: e, request: t, sameOrigin: n, url: s});
            let o = r && r.handler;
            const a = t.method;
        ...
        findMatchingRoute({url: t, sameOrigin: e, request: s, event: n}) {
            ...
            for (const r of i) {
                ...
                if (o) return i = o, (Array.isArray(o) && 0 === o.length || o.constructor === Object && 0 === Object.keys(o).length || "boolean" == typeof o) && (i = void 0), {route: r, params: i}
            }
            return {}
        }
    ...
    const h = {googleAnalytics: "googleAnalytics", precache: "precache-v2", prefix: "workbox", runtime: "runtime", suffix: "undefined" != typeof registration ? registration.scope : ""},
        u = t => [h.prefix, t, h.suffix].filter((t => t && t.length > 0)).join("-"), l = t => t || u(h.precache), f = t => t || u(h.runtime);
    ...
    async function R(t, e) {
        ...
        const i = t.clone(), r = {headers: new Headers(i.headers), status: i.status, statusText: i.statusText}, o = e ? e(r) : r, a = function () {
            if (void 0 === g) {
    ...
    class L {
        ...
        async cachePut(t, e) {
            ...
            if (!a) return !1;
            const {cacheName: h, matchOptions: u} = this.l, l = await self.caches.open(h), f = this.hasCallback("cacheDidUpdate"), w = f ? await async function (t, e, s, n) {
                const i = m(e.url, s);
            ...
            for (const t of this.iterateCallbacks("cacheDidUpdate")) await t({cacheName: h, oldResponse: w, newResponse: a.clone(), request: r, event: this.event});
            return !0
        }
        ...
        async getCacheKey(t, e) {
            if (!this.u[e]) {
                let s = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) s = U(await t({mode: e, request: s, event: this.event, params: this.params}));
                this.u[e] = s
            }
            return this.u[e]
        }
    ...
    class b extends class {
        ...
        handleAll(t) {
            ...
            const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request, n = "params" in t ? t.params : void 0, i = new L(this, {event: e, request: s, params: n}),
                r = this.q(i, s, e);
    ...
    class C {
        constructor({cacheName: t, plugins: e = [], fallbackToNetwork: s = !0} = {}) {
            this.k = new Map, this.P = new Map, this.T = new Map, this.l = new b({
                cacheName: l(t),
        ...
        install(t) {
            return w(t, (async () => {
                ...
                for (const [e, s] of this.k) {
                    const n = this.T.get(s), i = this.P.get(e), r = new Request(e, {integrity: n, cache: i, credentials: "same-origin"});
...
//# sourceMappingURL=workbox-df9df33b.js.map
